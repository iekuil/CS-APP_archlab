...
bool instr_valid = f_icode in 
	{ INOP, IHALT, IRRMOVQ, IIRMOVQ, IRMMOVQ, IMRMOVQ,
	  IOPQ, IJXX, ICALL, IRET, IPUSHQ, IPOPQ , IIADDQ }; # set iaddq as a valid instruction
...
bool need_regids =
	f_icode in { IRRMOVQ, IOPQ, IPUSHQ, IPOPQ, 
		     IIRMOVQ, IRMMOVQ, IMRMOVQ , IIADDQ }; # iaddq needs a regid byte

# Does fetched instruction require a constant word?
bool need_valC =
	f_icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ, IJXX, ICALL , IIADDQ }; # iaddq needs a constant word
...
word d_srcB = [
	D_icode in { IOPQ, IRMMOVQ, IMRMOVQ  , IIADDQ } : D_rB; # iaddq needs srcB, but not srcA
...
word d_dstE = [
	D_icode in { IRRMOVQ, IIRMOVQ, IOPQ , IIADDQ } : D_rB; #rB would be the destination when executing iaddq
	D_icode in { IPUSHQ, IPOPQ, ICALL, IRET } : RRSP;
...
word aluA = [
	...
	E_icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ , IIADDQ } : E_valC; # iaddq takes E_valC for input A
...
word aluB = [
	E_icode in { IRMMOVQ, IMRMOVQ, IOPQ, ICALL, 
		     IPUSHQ, IRET, IPOPQ , IIADDQ } : E_valB; # iaddq takes E_valB for input B
...
bool set_cc = ( E_icode == IOPQ || E_icode == IIADDQ ) &&	# as excuting iaddq, the cc should be updated
